...
public class JyDialog extends Dialog {
    ...
    public JyDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public JyDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
     ...
     */
    public JyDialog(Context context, float alpha, int gravity) {
        super(context);
