 ...
 */
public class JyTickerView extends View {
    ...
    private final JyTickerDrawMetrics metrics = new JyTickerDrawMetrics(textPaint);
    private final JyTickerColumnManager columnManager = new JyTickerColumnManager(metrics);
    ...
    public JyTickerView(Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public JyTickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public JyTickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public JyTickerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     *
     * <p>You can find some helpful character list generators in {@link JyTickerUtils}.
     *
     * <p>Special note: the character list must contain {@link JyTickerUtils#EMPTY_CHAR} because the
    ...
    public void setCharacterList(char[] characterList) {
        ...
        if (!foundEmpty) {
            throw new IllegalArgumentException("Missing JyTickerUtils#EMPTY_CHAR in character list");
        }
