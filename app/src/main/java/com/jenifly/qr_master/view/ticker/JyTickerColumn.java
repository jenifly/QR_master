...
class JyTickerColumn {
    ...
    private char currentChar = JyTickerUtils.EMPTY_CHAR;
    private char targetChar = JyTickerUtils.EMPTY_CHAR;
    ...
    JyTickerColumn(char[] characterList, Map<Character, Integer> characterIndicesMap,
                   JyTickerDrawMetrics metrics) {
