...
public class QRCode {
    ...
    private static ByteMatrix getBitMatrix(String contents) {
        try {
            com.google.zxing.qrcode.encoder.QRCode qrCode = getProtoQRCode(contents, ErrorCorrectionLevel.H);
     ...
     */
    private static com.google.zxing.qrcode.encoder.QRCode getProtoQRCode(String contents, ErrorCorrectionLevel errorCorrectionLevel) throws WriterException {
        if (contents.isEmpty()) {
